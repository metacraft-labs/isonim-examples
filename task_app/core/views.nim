## task_app/core/views.nim — Layer-2 high-level view.
##
...
## own renderer type, so this file compiles against any of the
## supported renderers (TerminalRenderer, MockRenderer / WebRenderer,
## GpuiRenderer, FreyaRenderer, CocoaRenderer, AndroidRenderer)
